package com.howdev.jwtauth.aspect;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectWriter;
import com.howdev.jwtauth.dto.BaseResponse;
import com.howdev.jwtauth.enumeration.RetCodeEnum;
import com.howdev.jwtauth.exception.LogMessageContainer;
import com.howdev.jwtauth.exception.RetCodeException;
import com.howdev.jwtauth.util.JacksonUtil;
import com.howdev.jwtauth.util.SpelUtil;
import com.howdev.jwtauth.util.SystemUtil;
import com.howdev.jwtauth.util.log.LogUtil;
import com.howdev.jwtauth.util.log.LoggerProxy;
...
//            + "|| within(@com.howdev.manage.annotation.ApiException *)")
     ...
     *
     */
    @Pointcut("execution(@com.howdev.jwtauth.annotation.ApiException com.howdev.jwtauth.dto.BaseResponse *(..)) " +
            "|| (execution(com.howdev.jwtauth.dto.BaseResponse *(..)) && within(@com.howdev.jwtauth.annotation.ApiException *)))")
    ...
    public Object process(ProceedingJoinPoint proceedingJoinPoint) {
        ...
        while (retryTime < MAX_RETRY_TIME && result == null) {
            ...
            try {
                ...
                result = BaseResponse.newFailResponse(RetCodeEnum.FAILED.getRetCode(), e.getMessage());
            }
