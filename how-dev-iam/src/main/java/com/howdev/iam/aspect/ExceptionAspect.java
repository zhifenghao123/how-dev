package com.howdev.iam.aspect;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectWriter;
import com.howdev.iam.dto.BaseResponse;
import com.howdev.iam.enumeration.RetCodeEnum;
import com.howdev.iam.exception.LogMessageContainer;
import com.howdev.iam.exception.RetCodeException;
import com.howdev.iam.util.JacksonUtil;
import com.howdev.iam.util.SpelUtil;
import com.howdev.iam.util.SystemUtil;
import com.howdev.iam.util.log.LogUtil;
import com.howdev.iam.util.log.LoggerProxy;
...
//            + "|| within(@com.howdev.manage.annotation.ApiException *)")
     ...
     *
     */
    @Pointcut("execution(@com.howdev.iam.annotation.ApiException com.howdev.iam.dto.BaseResponse *(..)) " +
            "|| (execution(com.howdev.iam.dto.BaseResponse *(..)) && within(@com.howdev.iam.annotation.ApiException *)))")
